...
const styles = StyleSheet.create({
  ...
  dropdown: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'rgba(239,239,239,0.5)', height: 44, borderRadius: 10, paddingHorizontal: 16 },
  ...
  sectionDescription: { fontSize: 12, color: '#9E9E9E', marginBottom: 20 },
  detailItem: { marginBottom: 4, fontSize: 13, color: '#333', lineHeight: 18 },
  tabContentSeparator: { height: 1, backgroundColor: '#E0E0E0', marginBottom:12 },
  ...
  navTextInactive: { color: '#616161', fontSize: 8, fontWeight: '600', marginTop: 2 },
    ...
    goodsContainer: { gap: 0},
    title: { fontSize: 20, fontWeight: "700", marginBottom: 4, marginTop: 36},
    subtitle: { fontSize: 12, color: "#9E9E9E", marginBottom: 12 },
    
    perkItem: { flexDirection: "row", justifyContent: "space-between", marginBottom: 8 },

    perkName: { fontWeight: "600" },
    perkDetail: { color: "#616161" },
    ...
    goodsPrice: { fontSize: 12, color: "#616161" },
    cartButton: { marginTop: 16, padding: 12, backgroundColor: "#efefef", borderRadius: 10, alignItems: "center" },
    cartText: { fontWeight: "600", color: "#FF59AD" },
    numberImage: { width: 18, height: 18, marginRight: 8 }
